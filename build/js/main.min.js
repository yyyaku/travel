...
},{"./modules/form-validate/form":3,"./modules/intro/init-audio-player":9,"./modules/intro/init-video-player":10,"./modules/intro/nav":11,"./modules/map/map":12,"./modules/modals/init-modals":13,"./modules/sliders/init-slider-advantages":15,"./modules/sliders/init-slider-gallery":16,"./modules/sliders/init-slider-instructors":17,"./modules/sliders/init-slider-intro":18,"./modules/sliders/init-slider-reviews":19,"./modules/sliders/init-slider-tours":20,"./utils/ios-vh-fix":23}],2:[function(require,module,exports){
"use strict";
...
var container = document.querySelector('.intro-audio');
var button = document.querySelector('.intro-audio__toggle');
...
var map = function map() {
  var map = L.map('map').setView([59.9684, 30.3176], 17);
