...
var _nav = require("./modules/intro/nav");
var _initVideoPlayer = require("./modules/intro/init-video-player");
var _initAudioPlayer = require("./modules/intro/init-audio-player");
var _initSliderIntro = require("./modules/sliders/init-slider-intro");
var _initSliderTours = require("./modules/sliders/init-slider-tours");
var _initSliderInstructors = require("./modules/sliders/init-slider-instructors");
var _initSliderReviews = require("./modules/sliders/init-slider-reviews");
require("./modules/sliders/init-slider-advantages");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initAudioPlayer.initAudioPlayer)();
    (0, _initSliderIntro.initSliderIntro)();
    (0, _initSliderTours.initSliderTours)();
    (0, _initSliderInstructors.initSliderInstructors)();
    (0, _initSliderReviews.initSliderReviews)();
    (0, _initSliderGallery.initSliderGallery)();
    (0, _map.map)();
  });
});
...
},{"./modules/form-validate/form":3,"./modules/intro/init-audio-player":9,"./modules/intro/init-video-player":10,"./modules/intro/nav":11,"./modules/map/map":12,"./modules/sliders/init-slider-advantages":13,"./modules/sliders/init-slider-gallery":14,"./modules/sliders/init-slider-instructors":15,"./modules/sliders/init-slider-intro":16,"./modules/sliders/init-slider-reviews":17,"./modules/sliders/init-slider-tours":18,"./utils/ios-vh-fix":20}],2:[function(require,module,exports){
"use strict";
...
exports.initAudioPlayer = exports.deleteAudioPlayer = void 0;
var container = document.querySelector('.intro-audio__container');
var button = document.querySelector('.intro-audio__play');
var wrapper = document.querySelector('.intro-audio__wrapper');
...
var deleteAudio = function deleteAudio() {
  audio.remove();
};
...
var deleteAudioPlayer = exports.deleteAudioPlayer = function deleteAudioPlayer() {
  deleteAudio();
...
exports.initVideoPlayer = exports.deleteVideoPlayer = void 0;
var container = document.querySelector('.intro-video__wrapper');
var cover = document.querySelector('.intro-video__wrapper').querySelector('img');
var button = document.querySelector('.intro-video__wrapper').querySelector('button');
...
var deleteVideoPlayer = exports.deleteVideoPlayer = function deleteVideoPlayer() {
  deleteVideo();
...
var introLogo = document.querySelector('.intro-header__logo');
var navMain = document.querySelector('.main-nav');
var navToggle = document.querySelector('.main-nav__toggle');
var overlay = document.querySelector('.overlay');
var slide = document.querySelector('.intro-main');
var body = document.querySelector('body');
var siteLinkTours = document.querySelector('.site-list__link--tours');
var siteLinkEducation = document.querySelector('.site-list__link--education');
var siteLinkAbout = document.querySelector('.site-list__link--about');
var siteLinkReviews = document.querySelector('.site-list__link--reviews');
var siteLinkGallery = document.querySelector('.site-list__link--gallery');
var siteLinkContacts = document.querySelector('.site-list__link--contacts');
var navButtonClick = exports.navButtonClick = function navButtonClick() {
...
var sliderAdvantages = document.querySelector('.advantages__swiper');
var sliderAdvantagesList = document.querySelector('.advantages__list');
var sliderAdvantagesCard = document.querySelector('.advantages-card');
...
var initSliderAdvantages = exports.initSliderAdvantages = new Swiper(sliderAdvantages, {
  navigation: {
    nextEl: buttonNext,
    prevEl: buttonPrev
  },
...
if (sliderAdvantages) {
  breakpoint.addEventListener('change', function (evt) {
    if (evt.matches) {
      // eslint-disable-next-line
      exports.initSliderAdvantages = initSliderAdvantages = new Swiper(sliderAdvantages, {
        navigation: {
          nextEl: buttonNext,
          prevEl: buttonPrev
        },
...
var initSliderInstructors = exports.initSliderInstructors = function initSliderInstructors() {
...
exports.initSliderIntro = void 0;
var _initVideoPlayer = require("../intro/init-video-player");
var _initAudioPlayer = require("../intro/init-audio-player");
var sliderIntro = document.querySelector('.intro__swiper');
var intro = document.querySelector('.intro');
var initSliderIntro = exports.initSliderIntro = function initSliderIntro() {
  if (sliderIntro) {
    // eslint-disable-next-line
    var swiper = new Swiper(sliderIntro, {
      loop: true,
      allowTouchMove: true,
      slidesPerView: 1,
      spaceBetween: 40,
    ...
    swiper.on('slideChange', function () {
      ...
      (0, _initVideoPlayer.deleteVideoPlayer)();
      (0, _initAudioPlayer.deleteAudioPlayer)();
...
},{"../intro/init-audio-player":9,"../intro/init-video-player":10}],17:[function(require,module,exports){
"use strict";
